...
from use_model.views import ImageProcessView, ImageProcessView2, ImageProcessView3
from django.conf import settings
from django.conf.urls.static import static
from manager.views import BusinessCodeViewSet
from car.views import CarViewSet
from manmodel.views import ManModelViewSet
...
router.register(r'manmodels', ManModelViewSet)
...
urlpatterns = [
    ...
    path('api/process-image2/', ImageProcessView2.as_view(), name='process_image'),
    path('api/process-image3/<int:image_id>/', ImageProcessView3.as_view(), name='process_image'),
